...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-07-2025 a las 23:39:46
...
(1, 'Evaluación de Usabilidad SUS', 'Encuesta estándar para medir usabilidad percibida', 'SUS', 1),
(2, 'CSAT - Satisfacción Post-Compra', 'Medición de satisfacción del cliente', 'CSAT', 1),
(3, 'NPS - Lealtad de Clientes', 'Medición de probabilidad de recomendación', 'NPS', 1);
...
INSERT INTO `preguntas` (`id`, `id_encuesta`, `texto`, `tipo_respuesta`, `orden`) VALUES
(1, 1, 'Creo que me gustaría usar este sitio web frecuentemente', 'escala_5', 1),
(2, 1, 'Encontré el sitio innecesariamente complejo', 'escala_5', 2),
(3, 1, 'Me pareció fácil de usar', 'escala_5', 3),
(4, 1, 'Creo que necesitaría ayuda técnica para usarlo', 'escala_5', 4),
(5, 1, 'Las funciones están bien integradas', 'escala_5', 5),
(6, 1, 'Hubo demasiada inconsistencia', 'escala_5', 6),
(7, 1, 'Imagino que la mayoría aprendería a usarlo rápidamente', 'escala_5', 7),
(8, 1, 'Lo encontré muy engorroso', 'escala_5', 8),
(9, 1, 'Me sentí confiado usándolo', 'escala_5', 9),
(10, 1, 'Necesité aprender muchas cosas antes de usarlo', 'escala_5', 10),
(11, 2, '¿Qué tan satisfecho estás con tu experiencia de compra?', 'escala_5', 1),
(12, 3, '¿Qué tan probable es que recomiendes nuestro sitio a un amigo o colega?', 'escala_10', 1);
